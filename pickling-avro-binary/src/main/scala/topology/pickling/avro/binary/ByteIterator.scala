...
object ByteIterator {
  object ByteArrayIterator {
    ...
    protected[topology] def apply(array: Array[Byte]): ByteArrayIterator =
      new ByteArrayIterator(array, 0, array.length)

    protected[topology] def apply(array: Array[Byte], from: Int, until: Int): ByteArrayIterator =
  ...
  object MultiByteArrayIterator {
    ...
    protected[topology] def apply(iterators: LinearSeq[ByteArrayIterator]): MultiByteArrayIterator =
  ...
  class MultiByteArrayIterator private (private var iterators: LinearSeq[ByteArrayIterator]) extends ByteIterator {
    ...
    private[topology] def ++:(that: ByteArrayIterator): this.type = {
