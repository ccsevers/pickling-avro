/**
  ...
  *
  * Reproduced from the Akka project to reduce external package dependencies.
  */
...
object ByteString {
  ...
  private[topology] object ByteString1C {
  ...
  final class ByteString1C private (private val bytes: Array[Byte]) extends CompactByteString {
    ...
    private[topology] def toByteString1: ByteString1 = ByteString1(bytes)
  ...
  private[topology] object ByteString1 {
  ...
  private[topology] object ByteStrings {
  ...
  /**
    ...
    */
  final class ByteStrings private (private[topology] val bytestrings: Vector[ByteString1], val length: Int) extends ByteString {
